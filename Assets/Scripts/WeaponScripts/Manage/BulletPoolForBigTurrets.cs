...
public class BulletPoolForBigTurrets : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        for (int i = 0; i < initialPoolSize; i++)
        {
            ...
            bullet.GetComponent<TurretBulletForBigTurret>().SetBulletPool(this);
    ...
    public GameObject GetBullet(Vector3 position, Quaternion rotation)
    {
        if (bulletPool.Count == 0)
        {
            ...
            bullet.GetComponent<TurretBulletForBigTurret>().SetBulletPool(this); // Set pool reference
            bulletPool.Enqueue(bullet);
        }
